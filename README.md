<div align="center">
  <h1>🚀 Nexa — The Personal Daily Super App</h1>
  <p>
    <img src="https://img.shields.io/badge/Platform-Android-3DDC84?style=for-the-badge&logo=android" alt="Android Badge" />
    <img src="https://img.shields.io/badge/Java-11-ED8B00?style=for-the-badge&logo=java" alt="Java Badge" />
    <img src="https://img.shields.io/badge/Firebase-Firestore-FFCA28?style=for-the-badge&logo=firebase" alt="Firebase Badge" />
    <img src="https://img.shields.io/badge/Material%20Design-3-6200EE?style=for-the-badge&logo=material-design" alt="Material Design 3" />
  </p>
  <p>
    <i>A modern, premium Android application designed to serve as a comprehensive daily helper. It seamlessly integrates personal finance tracking, group expense splitting, task management, notes, reminders, and visual analytics into a unified, high-performance super app.</i>
  </p>
</div>
...
- **Personalized Greeting**: Dynamic, hour-based greeting card (Morning/Afternoon/Evening/Night) with a user profile avatar.
- **Financial Status at a Glance**: Clear display of cash balance, bank balance, and net total balance.
- **Productivity Previews**: Shows your next pending task, upcoming reminders (with trigger time), and active group count.
- **Quick Action Bar**: Lightning-fast navigation to add cashbook entries, schedule tasks, set reminders, or view reports.
...
- **Smart Debt Simplification**: Computes complex debts between multiple members and uses a greedy settlement algorithm to suggest the absolute minimum number of payments.
...
- **Interactive Checklists**: Complete tasks directly from the list with striking line-through styling.
- **Timeframe Filters**: Access views for Today, This Week, Completed, or All tasks.

### 5. Staggered Notes Grid
- **Modern Grid Layout**: Uses a staggered grid layout for beautiful readability of note cards.
